...
void ClusterHelper(const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol, int curr_idx, std::vector<bool>& processed, std::vector<int>& cluster){
  //mark as processed
